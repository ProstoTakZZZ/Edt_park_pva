...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для Сч = 0 По Диапазоны.Количество() - 1 Цикл
		...
		Если Диапазон.НижняяГраница >= Диапазон.ВерхняяГраница 			
			И Сч <> Диапазоны.Количество() - 1 Тогда
				Отказ = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = СтрШаблон("Верхняя граница всегда должна быть больше нижней");
				Сообщение.УстановитьДанные(ЭтотОбъект);
	...
	Если ПоследнийДиапазон.ВерхняяГраница <> 0 Тогда
		Отказ = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = СтрШаблон("Верхняя граница первого диапазона всегда должна быть равна 0");
		Сообщение.УстановитьДанные(ЭтотОбъект);
